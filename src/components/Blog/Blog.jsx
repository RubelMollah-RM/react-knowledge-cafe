        ...
        <div className='mt-4 mb-20 p-5'>
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center'>
                    ...
                    <button onClick={() => handelAddToBookMark(blog)} className='text-red-500 text-xl ml-2'><FaBookmark /></button>
                </div>
            </div>
            ...
            <button onClick={ () => handelMarkAsRead (reading_time)} className='underline text-purple-600 mt-4'>Mark as read</button>
        </div>
    );
};
